...
const Services = () => {
  return (
    ...
    <p className='lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7'>Aikinyi Estate is the best place to find
     your next perfect place to live. We have a wide range of properties for you to choose from.</p>
    </div>
    ...
    <div className='hidden absolute w-1 sm:block bg-green-900 h-full left-1/2 transform -translate-x-1/2'></div>
       ...
       <p className='text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7'>Aikinyi Estate is the best place to find
       your next perfect place to live. We have a wide range of properties for you to choose from.</p>
       </div>
       </div>
       </div>
       ...
       <img src={backendImg} alt=''/>
         ...
         <h3 className='text-headingColor font-[700] mb-3 group-hover:text-white group-hover:font-[600] text-xl'>UI Ux</h3>
         <p className='text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7'>Aikinyi Estate is the best place to find
         your next perfect place to live. We have a wide range of properties for you to choose from.</p>
         </div>
         </div>
         ...
         <h3 className='text-headingColor font-[700] mb-3 group-hover:text-white group-hover:font-[600] text-xl'>Mobile Apps Development</h3>
         <p className='text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7'>Aikinyi Estate is the best place to find
         your next perfect place to live. We have a wide range of properties for you to choose from.</p>
         </div>
         </div>
